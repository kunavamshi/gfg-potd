class Solution:
    def boundaryTraversal(self, root):
        ...
        # Function to get left boundary (excluding leaf nodes)
        ...
        # Function to get leaf nodes in left-to-right order
        def getLeaves(node):
            if node:
                getLeaves(node.left)
                if isLeaf(node):
        ...
        # Function to get right boundary (excluding leaf nodes, in reverse order)
